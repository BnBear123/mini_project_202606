...
- chromadb 적재까지 하는 코드
  ...
  - 보완점 3 : 기사에 대한 날짜가 없음... 또는 사건이 일어난 일자나 시점이 없음... metadata로 기사 일자를 넣어주거나 해야할듯... 아니면 chromadb에 저장될 때 일자가 찍히나?
<br/>

## 보완점
- 2026.07.07
    - chromadb에 적재할 때 metadata에 기사 날짜 정보를 넣어줘야함
    - 사용자 질문을 분석하고 임베딩을 해야하는데 그런 단계가 없음 <br>
=> 2026.07.09 `retry_stack_chrma.py` metadata에 pubDate 추가 완료
